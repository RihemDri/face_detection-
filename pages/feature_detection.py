...
smile_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_smile.xml')   # mouth replacement

# Optional nose cascade: must be downloaded manually
nose_cascade_path = "nose.xml"  # put your downloaded file in same folder
nose_cascade = cv2.CascadeClassifier(nose_cascade_path)


# ---------------------------------------------------------------------------
# Function: Webcam Face Detection
# ---------------------------------------------------------------------------
def detect_faces():
